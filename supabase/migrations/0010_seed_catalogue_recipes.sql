-- Seed the shared recipe catalogue with properly-attributed demo recipes.
-- This is idempotent: re-running will skip rows that already exist.
-- The same data lives in supabase/seed/recipes.sql for manual seeding.
...
-- Hero images from TheMealDB for each seeded recipe.
